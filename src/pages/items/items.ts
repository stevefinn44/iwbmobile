...
@Component({
    ...
    providers: [MailChimpService, TextViewService, SpinnerService,
      ...
      ListViewStickyListHeaderService, HttpService, ValidationService, MapsService, QRCodeService,
      RadioButtonService, RangeService, ToggleService, SelectService, ActionSheetService]
})
